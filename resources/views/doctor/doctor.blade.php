        ...
        <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    ...
                    <a href="{{url('doctor_appointments')}}" class="text-white text-center d-block"><button class="btn btn-primary">Show the list</button></a>
                </div>
            </div>
        </div>
        <div class="accordion-item">
            ...
            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    ...
                    <a href="{{url('doctor_appointments')}}" class="text-white text-center d-block"><button class="btn btn-primary">Show list</button></a>
                </div>
            </div>
        </div>
        <div class="accordion-item">
