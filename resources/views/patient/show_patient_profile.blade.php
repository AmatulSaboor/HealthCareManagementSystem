...
<div class="container" >
    ...
    {{-- {{/storage/DcRg8y65kyjIpyOiLOyzc4hS8DGdYiPEK4EjFIc4.}} --}}
    <!-- Patient Profile -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{$patient->patientDetail->image_link ? $patient->patientDetail->image_link :'https://bootdey.com/img/Content/avatar/avatar7.png'}}" alt="src not found" class="rounded-circle" width="150">
                                    <div class="mt-3">
                                        <h4>{{$patient->name}}</h4>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">{{$patient->patientDetail->dob}}</div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">{{$patient->patientDetail->phone_number}}</div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">{{$patient->patientDetail->address}}</div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">{{$patient->patientDetail->city}}</div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-sm-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">{{$patient->patientDetail->weight}}</div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-sm-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <a class="btn btn-primary" href="{{url('patient/'.$patient->id.'/edit')}}">Edit</a>
                                    </div>
                                </div>
                            </div>
                        </div>
